...
export const MENUITEMS = [
    ...
    // },
    {
        path: '/User/user-list', title: 'User', icon: Users, type: 'link', active: false
    },
    {
        title: 'Transaction',path:'/transaction', icon: DollarSign , type: 'link', active: false,
    },
    {
        title: 'Games', icon: FaDiceD20 , type: 'sub', active: false, children: [
    ...
    {
        title: 'Manage Prizes',path:'/prizes', icon: FaGift , type: 'link', active: false,
    },
    {
        title: 'KYC',path:'/kyc', icon: FaAddressCard , type: 'link', active: false,
    },
    {
