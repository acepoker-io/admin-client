        ...
        <Form onSubmit={handleSubmit(createTournament)}>
          ...
          <Modal.Body>
            <div className="opentableModal">
              ...
              {winTotalPlayer?.value&&watchPrizeType&&watchPrizeType !=='Percentage'&&(winTotalPlayer?.value === "3" ||
                ...
                <div className="opentable-userByinput winner-row">
                  <Form.Group className="userBuy">
                    ...
                    <Form.Control
                      type="number"
                      name="first"
                      defaultValue={singleTournament?.winPlayer?.first?.amount}
                  ...
                  <Form.Group className="userBuy">
                    ...
                    <Form.Control
                      type="number"
                      name="second"
                      defaultValue={singleTournament?.winPlayer?.second?.amount}
                      placeholder="Enter Amount"
                      {...register("second")}
                    />
                  </Form.Group>
                  <Form.Group className="userBuy">
                    ...
                    <Form.Control
                      type="number"
                      name="third"
                      defaultValue={singleTournament?.winPlayer?.third?.amount}
                      placeholder="Enter Amount"
                      {...register("third")}
                    />
                  </Form.Group>
              ...
              <div className="opentable-userByinput">
                <Form.Group className="userBuy">
                  ...
                  />
                  {errors?.incBlindTime && (
                    <p className="error-msg">{errors?.incBlindTime?.message}</p>
                  )}
                </Form.Group>
                <Form.Group className="userBuy">
