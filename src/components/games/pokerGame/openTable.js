...
const OpenTable = ({ allRooms, setKeyword, getAllPokerTable }) => {
  ...
  return (
    <div className='OpenTable'>
          ...
          {allRooms?.map((room) => (
            <div className='tablecard'>
              <div className='cardImgContainer'>
                ...
                <span className="trashTable" onClick={() => handleDeleteTable(room)}><Trash /></span>
              </div>
      ...
      <CreatePokerTableModal show={show} setShow={setShow} onHide={handleClose} getAllPokerTable={getAllPokerTable} />
      <DeletePopup
        show={deletePopup}
